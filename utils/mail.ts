...
I'm very happy that you want to sell your BAN on the Marketplace, here are your credentials:
...
There will be two types of requests: Offer requests and Payment requests. Offer requests are made to get the amount of BAN you want to sell and the price at which you want to sell them. I will send a GET-Request to your webhook endpoint and you respond with a JSON object containing balance and rate.
Payment requests are made to send the BAN to the buyer: I will send a POST-Request to your webhook endpoint and you respond with the transaction hash.
...
You sell your BAN at a minimum of ${source.price.min} cents, after which you ${
  source.price.market ? "" : "don't"
