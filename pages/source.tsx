  ...
  return (
    <Layout>
      <main className="text-lg text-dark mt-10 md:grid mx-auto max-w-4xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
        ...
        <p>
          Do you want to sell your {chain.toUpperCase()} to other enthusiasts? You can easily do so
          by signing up for a merchant account and selecting a way to fulfill the orders that you
          receive:
        </p>
        ...
        <form action="/api/create">
          ...
          <ul>
            ...
            <br />
            <li>
              <b>The full-control way:</b> You set up a server that handles offer creation and
              sending the {chain.toUpperCase()} to the customer. You remain in full-control over
              your funds. We provide tutorials to set up the server quickly.
            </li>
          </ul>
          <br />
          <input
          ...
          {fulfillmentMethod === "custodial" ? (
            ...
            <>
              ...
              <p>
                We need to make a GET request to receive your latest balance and{" "}
                {chain.toUpperCase()} rate as well as a POST request as soon as the users pays. For
                information on how to set up the server, see <a href="/setup">our documentation.</a>
              </p>
              <br />
